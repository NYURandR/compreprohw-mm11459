...
By utilizing Version Control in R Studio, which is capable of tracking changes you make to data sets, charts, and programs, and these changes can be later audited transparently by an interested party or yourself. It is also useful to be able to transfer these changes to a repository like GitHub, which allows public access to the data throughout the research process. 
